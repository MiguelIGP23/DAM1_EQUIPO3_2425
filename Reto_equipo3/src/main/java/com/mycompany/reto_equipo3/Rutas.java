...
public class Rutas {
    ...
    public Rutas(int idRuta, Clasificacion clasificacion, int nivelEsfuerzo, int nivelriesgo, boolean estadoRuta, int tipoterreno, int indicaciones, boolean rutaFamiliar, double mediaEstrellas) {
        this.idRuta = idRuta;
        this.clasificacion = clasificacion;
