 ...
 */
public class DAOImagenesPeligro implements InterfazDAO<DAOImagenesPeligro>{
    ...
    @Deprecated
    @Override
    public void modificar(DAOImagenesPeligro obj) {
    ...
    @Deprecated
    @Override
    public DAOImagenesPeligro buscar(String email) {
        //Metodo comun pero no implementado
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}
