...
public class SwingPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pppiIMG = new javax.swing.JPanel();
        jLabel7 = new javax.swing.JLabel();
        jScrollPane9 = new javax.swing.JScrollPane();
        TablePuntosInteresIMG = new javax.swing.JTable();
        ...
        pppiIMG.setBackground(new java.awt.Color(153, 255, 153));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 2, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(102, 102, 255));
        jLabel7.setText("        Imagenes");

        TablePuntosInteresIMG.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        TablePuntosInteresIMG.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                TablePuntosInteresIMGAncestorAdded(evt);
            }
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
        ...
        jScrollPane9.setViewportView(TablePuntosInteresIMG);
        ...
        javax.swing.GroupLayout pppiIMGLayout = new javax.swing.GroupLayout(pppiIMG);
        pppiIMG.setLayout(pppiIMGLayout);
        pppiIMGLayout.setHorizontalGroup(
            pppiIMGLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pppiIMGLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jButton5)
                .addGap(55, 55, 55))
            .addGroup(pppiIMGLayout.createSequentialGroup()
                .addGroup(pppiIMGLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pppiIMGLayout.createSequentialGroup()
                        .addGap(114, 114, 114)
        ...
        pppiIMGLayout.setVerticalGroup(
            pppiIMGLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pppiIMGLayout.createSequentialGroup()
                .addGap(46, 46, 46)
                .addComponent(jLabel7)
        ...
        getContentPane().add(pppiIMG, "card11");
    ...
    private void TableRutasValidasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableRutasValidasMouseClicked
        ...
        if (fila != -1) {
            ...
            Object opcion = JOptionPane.showInputDialog(null, "Seleccione una opcion",
                    ...
                    new Object[]{"Seleccione", "Puntos Interes y Puntos Peligro", "Detalles de la ruta", "Valoraciones", "Actividades", "Imagenes de Interes y Imagenes de Peligro"}, "Seleccione");
            switch (opcion.toString()) {
                ...
                case "Imagenes de Interes y Imagenes de Peligro" -> {
                    idrutaapipp = resultado;
                    RutasValidas.setVisible(false);
                    pppiIMG.setVisible(true);
                }
            }
        }
...
// Tabla valoraciones
    ...
    private void TablePuntosInteresIMGAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_TablePuntosInteresIMGAncestorAdded
        DAOImagenesInteres daoimg = new DAOImagenesInteres();
        List<ImagenesInteres> lisimg = daoimg.listarPorPuntoInteres(idrutaapipp);
        DefaultTableModel model = new DefaultTableModel();
        model.addColumn("ID PuntosPeligro");
        model.addColumn("URL");
        model.addColumn("Descripcion");
    ...
    }//GEN-LAST:event_TablePuntosInteresIMGAncestorAdded
        }
        TablePuntosInteresIMG.setModel(model);

        TablePuntosInteresIMG.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int fila = TablePuntosInteresIMG.rowAtPoint(e.getPoint());
                int columna = TablePuntosInteresIMG.columnAtPoint(e.getPoint());
                if (columna == 1) {
                    ImageIcon icono = (ImageIcon) TablePuntosInteresIMG.getValueAt(fila, columna);
                    String descripcion = (String) TablePuntosInteresIMG.getValueAt(fila, 2);
                    if (icono != null) {
    ...
    private javax.swing.JTable TablePuntosInteresIMG;
    ...
    private javax.swing.JPanel pppiIMG;
