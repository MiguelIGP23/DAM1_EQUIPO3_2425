...
INSERT INTO `rutas` VALUES (1,'Paseo por el bosque','Bar manolo','Fuente del rio',0.2345,2.3625,0.2536,2.2345,23,'00:15:00',90,20,1300,1150,'lineal',4,3,1,2,4,'verano,primavera',1,1,'http://','Lleva cervecitas','norte',4,1),(2,'Subida al everest','salida del bosque','pico mas alto',4.2356,8.3625,4.2476,9.6345,120,'00:15:00',4532,600,8400,1340,'lineal',5,5,0,3,3,'invierno',1,1,'http://','Suerte o muerte','sur',3,1);
